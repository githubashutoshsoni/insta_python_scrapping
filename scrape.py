...
# webdriver.get('https://ww.instagram.com')

sleep(3)

# comment_field=webdriver.find_element_by_name('Add a comment')
# comment_field.send_keys('https://www.oneplus.in/invite#PEZKnaoXVuL9FSejVUnKUH')
# comment_field.send_keys(Keys.ENTER)


hashtag_list = ['oneplus7t','oneplus7tpro', 'shotononeplus', 'oneplus', 'oneplus5','hazeblue']
# - if it's the first time you run it, use this line and comment the two below
prev_user_list = [] 
# prev_user_list = pd.read_csv('20200104-153519_users_followed_list.csv', delimiter=',').iloc[:,1:2] # useful to build a user log
        ...
        for x in range(1,200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    comm_prob = 10
                    print('comment prob is  {}_{}: {}'.format(hashtag, x,comm_prob))
                    if comm_prob > 7:
                        comments += 1
                        ...
                        if (comm_prob < 7):
                            ...
                            comment_box.send_keys('If you are from India, use my coupon to get discount on buying a new oneplus  https://www.oneplus.in/invite#PEZKnaoXVuL9FSejVUnKUH')
                            sleep(1)
